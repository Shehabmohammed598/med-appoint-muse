    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20 flex items-center justify-center p-4">
      ...
      <Card className="w-full max-w-lg shadow-2xl border-0 bg-card/80 backdrop-blur-sm">
        ...
        <CardContent className="px-8 pb-8">
          {/* Existing session notice - shows login first but offers to continue */}
          {user && (
            <div className="mb-6 p-3 rounded-md border border-border bg-muted/40 flex flex-col sm:flex-row items-center gap-3 justify-between">
              <p className="text-sm text-muted-foreground">An existing session was found.</p>
              <div className="flex gap-2">
                <Button size="sm" onClick={handleContinueWithSession}>
